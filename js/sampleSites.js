var sites = [{
        ...
        deprecated: 'false',
        skills: "html, css, sql, php, javascript, jquery, drupal"
        },
        {
        name:'Museum Tour',
        shortname: 'museum',
        url:'http://MuseumTour.com',
        description:'Project Manager and Lead Developer on site re-skin completed 10/1/2013. Development included new UI using Jquery for multiple product listings interacting with shopping cart.',
        deprecated: 'false',
        ...
        name:'Zepher Inc',
        shortname: 'zepher',
        url:'http://Zepherinc.com',
        description:'Managed creation of Pixel Perfect Wordpress site from PSD file.',
        deprecated: 'false',
        skills: "html, css, sql, php, xml, javascript, jquery, PM, WP child theme"
        },
        {
        name:'Nineteen67.com',
        shortname: 'nineteen',
        ...
        {
        name:"Sbirtoregon.org",
        shortname: 'sbirt',
        url:'http://www.sbirtoregon.org/training.php',
        description:'Created a javascript movie player for modern browsers. Updated and maintained html5 site.', 
        deprecated: 'false',
        skills: "html, css, sql, php, xml, javascript, jquery,PM"
        },
        {
        ...
        {
        name: "feedachildsmind.org",
        shortname: 'feed',
        url: '',
        description: 'Providing updates and bug fixes to this MVC style Content Management System(CMS) based on CodeIgniter and fuel.', 
        deprecated: 'true',
        skills: "html, css, sql, php,PM"
        },
        {
        name: 'Headhunters NW', 
        ...
        {
        name: 'Keypublishinggroup.com',
        shortname: 'key',
        url: 'http://keypublishinggroup.com',
        description: 'Built this in house using PHP, HTML 5 and a bit of jquery. There are also two self posting forms on this site. I skinned the photoshop files produced by our Art Director and produced the site in a few days.', 
        deprecated: 'false',
        ...
        shortname: 'nvoice',
        url: 'nvoicepay.com',
        description: 'As the project manager on this site I was responsible for updates to the public facing Wordpress site as well as integration of the SAAS invoicing system.', 
        deprecated: 'true',
        skills: "html, css, sql, php, PM, wordpress, UI"
        },
        {
        name: 'Virtensys.com',
        shortname: 'virtensys',
        url: '',
        description: 'As the project manager on this Drupal site I was responsible for content updates.', 
        deprecated: 'true',
        skills: "html, css, sql, php, PM, wordpress, UI"
        },
        {
        ...
        {
        name: 'MagnoliaSeniorCare.com',
        shortname: '',
        url:'',
        description:'In this project I designed a custom Wordpress theme in Photoshop. I then produced this multi-page website.',
        deprecated: 'true',
        skills: "html, css, sql, php, wordpress, PM, wireframes, UI"
        },
        {
        ...
        {
        name: 'cos-orthopaedics.com',
        shortname: '',
        url:'',
        description:'A simple static site with some nice FLA. I functioned as the art director and systems manager. This site has since been replaced.',
        deprecated: 'true',
        skills: "html, css, sql, coldfusion, flex, flash, PM, wireframes, UI"
        },
        {
